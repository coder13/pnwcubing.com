      ...
      <section className="flex justify-center w-full px-4 space-y-4 py-4 bg-secondary bg-opacity-80">
        <div className="flex flex-col md:w-2/3 w-full">
          <p>
            ...
            to have you join us in the world of speedcubing. World Cube
            Association Competitions have historically been an amazing space for
            people of all ages to come together and meet with like-minded
            individuals.
          </p>
          <p>
      ...
      <section className="flex justify-center w-full px-4 space-y-4 py-4 bg-white">
        <div className="flex flex-col md:w-2/3 w-full space-y-4">
          ...
          <p>
            ...
            Clement made a video guide to competing at competitions that is a
      ...
      <section className="flex justify-center w-full px-4 space-y-4 py-4 bg-secondary bg-opacity-80">
        <div className="flex flex-col md:w-2/3 w-full space-y-4">
          ...
          <p>
            ...
            the start of the day during check-in. Judging is very easy and we
            are always happy to teach you!
          </p>
          <p>
            We will need help judging later in the day during our final rounds
            of events. Spectators are encouraged to learn how to judge; you do
            not need to know how to cube in order to be a judge. Having enough
